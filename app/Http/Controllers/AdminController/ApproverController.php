...
class ApproverController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        return redirect()->route('admin.approver.index')->with('success', 'Successfully create approver.');
    }
    ...
    public function update(User $approver, Request $request) {
        ...
        return redirect()->route('admin.approver.index')->with('success', 'Successfully update approver.');
    }

    public function destroy(User $approver) {
        $approver->delete();

        return redirect()->route('admin.approver.index')->with('success', 'Successfully delete approver.');
    }
}
