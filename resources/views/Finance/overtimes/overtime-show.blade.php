...
@section('content')
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-soft border border-neutral-200 p-6">
            <form method="GET" action="{{ route('finance.overtimes.index') }}" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                ...
                <div class="flex items-end">
                    ...
                    <a href="{{ route('finance.overtimes.index') }}" class="btn-secondary">
