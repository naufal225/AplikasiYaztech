...
<main class="relative z-10 flex-1 p-0 space-y-6 overflow-x-hidden overflow-y-auto bg-gray-50">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="text-neutral-600">Manage and track your overtime requests</p>
        </div>
        <div class="mt-4 sm:mt-0">
            <div class="flex flex-col gap-3 mt-4 sm:mt-0 sm:flex-row">
                <button id="exportOvertimeRequests"
    ...
    <div class="p-6 bg-white border rounded-xl shadow-soft border-neutral-200">
        <form id="filterForm" method="GET" action="{{ route('approver.overtimes.index') }}"
            ...
            <div class="flex items-end">
                ...
                <a href="{{ route('approver.overtimes.index') }}" class="btn-secondary">
                    ...
                    <thead class="bg-neutral-50">
                        <tr>
                            <th
                                ...
                                Request ID</th>
                            <th class="py-3 text-xs font-medium tracking-wider text-left uppercase -6 text-neutral-500">
                                Employee</th>
                            <th
                                class="px-6 py-3 text-xs font-medium tracking-wider text-left uppercase text-neutral-500">
                                Duration</th>
