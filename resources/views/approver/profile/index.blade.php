            ...
            <div class="px-6 py-4 space-y-4">
                ...
                <div>
                    <button onclick="openPasswordModal()"
                        class="px-4 py-2 font-medium text-white transition-colors bg-gray-600 rounded-lg hover:bg-gray-700">
...
<div id="editProfileModal" class="fixed inset-0 z-50 hidden bg-black/20">
    <div class="flex items-center justify-center min-h-screen p-4">
        <div class="w-full max-w-md bg-white rounded-lg shadow-xl">
            <form action="{{ route('approver.profile.update', Auth::id()) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
