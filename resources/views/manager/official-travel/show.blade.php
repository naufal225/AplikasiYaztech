...
<div class="max-w-4xl mx-auto">
    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div class="space-y-6 lg:col-span-2">
            ...
            <div class="bg-white border rounded-xl shadow-soft border-neutral-200">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center p-3 border rounded-lg bg-neutral-50 border-neutral-200">
                                ...
                                <span class="font-medium text-neutral-900">{{ $officialTravel->employee->email ?? 'N/A' }}</span>
                            </div>
                        </div>
                        <!-- Aanager -->
                        <div class="space-y-2">
                    ...
                    @if($officialTravel->final_status !== 'pending' && !empty($officialTravel->approval_notes))
                    <div class="mt-6 space-y-2">
                        <label class="text-sm font-semibold text-neutral-700">
                            @if($officialTravel->final_status === 'approved')
                            Approval Notes
                            @else
                            Rejection Notes
                            @endif
                        ...
                        <div class="p-4 border rounded-lg
                            ...
                            <p class="leading-relaxed
                                ...
                                @else
                                    text-error-900
                                @endif">{{ $officialTravel->approval_notes }}</p>
                        </div>
                    </div>
                    @endif
                </div>
        ...
        <div class="space-y-6">
            ...
            @if($officialTravel->final_status === 'pending' && $officialTravel->status_2 == 'pending')
            <div class="bg-white border rounded-xl shadow-soft border-neutral-200">
                <div class="px-6 py-4 border-b border-neutral-200">
                    <h3 class="text-lg font-bold text-neutral-900">Review Request</h3>
                </div>
                <div class="p-6">
                    <form id="approvalForm" method="POST" action="{{ route('manager.official-travels.update', $officialTravel) }}">
                        @csrf
                        @method('PUT')
...
<script>
    function submitApproval(action) {
        ...
        // const confirmMessage = `Are you sure you want to ${actionText} this officialTravel request?`;
