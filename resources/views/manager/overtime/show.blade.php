                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center p-3 border rounded-lg bg-neutral-50 border-neutral-200">
                                ...
                                <span class="font-medium text-neutral-900">{{ \Carbon\Carbon::parse($overtime->date_start)->format('l, M d, Y') }}</span>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center p-3 border rounded-lg bg-neutral-50 border-neutral-200">
                                <i class="mr-3 fas fa-calendar-alt text-primary-600"></i>
                                <span class="font-medium text-neutral-900">{{ \Carbon\Carbon::parse($overtime->date_end)->format('l, M d, Y') }}</span>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center p-3 border rounded-lg bg-neutral-50 border-neutral-200">
                                ...
                                @php
                                    $duration = \Carbon\Carbon::parse($overtime->date_start)->diffInDays(\Carbon\Carbon::parse($overtime->date_end)) + 1;
                                @endphp
                        ...
                        @if($overtime->status_2 !== 'pending' && $overtime->note_2)
                            <div class="space-y-2 md:col-span-2">
                                <label class="text-sm font-semibold text-neutral-700">
                                    {{ $overtime->status_2 === 'approved' ? 'Approval Notes (Manager)' : 'Rejection Notes (Manager)' }}
                                </label>
                ...
                <div class="p-6 space-y-3">
                    @if(Auth::id() === $overtime->employee_id && $overtime->status_1 === 'pending')
                        ...
                        <button
                            ...
                            data-overtime-name="Overtime Request #{{ $overtime->id }}"
                            title="Delete">
...
<form id="delete-form-{{ $overtime->id }}"
      action="{{ route('manager.overtimes.destroy', $overtime->id) }}"
      method="POST"
      style="display: none;">
    @csrf
    @method('DELETE')
