...
<div class="max-w-4xl mx-auto">
    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            ...
            <div class="overflow-hidden bg-white border rounded-xl shadow-soft border-neutral-200">
                <div class="px-6 py-4 bg-gradient-to-r from-primary-600 to-primary-700">
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <h1 class="text-xl font-bold text-white">Reimbursement Request #{{ $reimbursement->id }}</h1>
                    ...
                    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="flex items-center p-3 border rounded-lg bg-neutral-50 border-neutral-200">
                                ...
                                <span class="font-medium text-neutral-900">{{ $reimbursement->employee->email ?? 'N/A' }}</span>
                            </div>
                        </div>
                        <!-- manager -->
                        <div class="space-y-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="p-4 border rounded-lg bg-neutral-50 border-neutral-200">
                                <p class="leading-relaxed text-neutral-900">{{ $reimbursement->customer->name ?? "N/A" }}</p>
                            </div>
                        </div>
                        <div class="space-y-2">
        ...
        <div class="space-y-6">
            ...
            @if($reimbursement->final_status === 'pending' && $reimbursement->status_2 == 'pending')
            <div class="bg-white border rounded-xl shadow-soft border-neutral-200">
                <div class="px-6 py-4 border-b border-neutral-200">
                    <h3 class="text-lg font-bold text-neutral-900">Review Request</h3>
                </div>
                <div class="p-6">
                    <form id="approvalForm" method="POST" action="{{ route('manager.reimbursements.update', $reimbursement) }}">
                        @csrf
                        @method('PUT')
