...
<main class="relative z-10 flex-1 p-0 space-y-6 overflow-x-hidden overflow-y-auto bg-gray-50">
    ...
    <<div class="p-6 bg-white border rounded-xl shadow-soft border-neutral-200">
        <form id="filterForm" method="GET" action="{{ route('manager.reimbursements.index') }}"
            ...
            <div class="flex items-end">
                ...
                <a href="{{ route('manager.reimbursements.index') }}" class="btn-secondary">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    exportButton.addEventListener('click', async function() {
        ...
        try {
            ...
            const exportUrl = `{{ route('manager.reimbursements.export') }}?${params.toString()}`;
