...
<div class="fixed inset-y-0 left-0 z-30 flex flex-col w-64 text-white transition-transform duration-300 ease-in-out transform -translate-x-full sidebar-container bg-primary-800 shadow-medium lg:relative lg:translate-x-0"
    ...
    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto sidebar-scroll">
        ...
        <!-- Cost Settings Menu -->
        <a href="{{ route('super-admin.cost-settings.index') }}"
            class="flex items-center px-4 py-3 rounded-lg transition-all duration-200 {{ request()->routeIs('super-admin.cost-settings.*') ? 'bg-primary-700 text-white shadow-soft' : 'text-primary-100 hover:bg-primary-700 hover:text-white' }}">
