    ...
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <div style="margin: 20px 0;">
                ...
                <p style="margin: 5px 0;"><strong style="color: #4f46e5;">Email:</strong> {{ $emailPengaju ?? 'Tidak disertakan' }}</p>
            ...
            <a href="{{ $linkTanggapan ?? '#' }}" class="button">Approve/Reject</a>
        </div>
        
        <div class="footer">
            <p style="margin: 5px 0;">© {{ date('Y') }} Yaztech Engineering Solusindo</p>
            <p style="margin: 5px 0; font-size: 11px;">Email ini dikirim secara otomatis, harap tidak membalas langsung.</p>
        </div>
    </div>
</body>
</html>