...
@section('content')
    <div class="max-w-3xl mx-auto">
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <a href="{{ route('admin.reimbursements.index') }}" class="text-sm font-medium text-neutral-700 hover:text-primary-600">Reimbursement Requests</a>
                    </div>
                </li>
        ...
        <div class="bg-white border rounded-xl shadow-soft border-neutral-200">
            ...
            <form action="{{ route('admin.reimbursements.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                @csrf
                ...
                <div class="flex justify-end pt-6 space-x-4 border-t border-neutral-200">
                    <a href="{{ route('admin.reimbursements.index') }}" class="px-6 py-2 text-sm font-medium transition-colors duration-200 rounded-lg text-neutral-700 bg-neutral-100 hover:bg-neutral-200">
