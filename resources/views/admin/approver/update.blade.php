    ...
    <div class="max-w-2xl mx-auto">
        <div class="overflow-hidden bg-white border border-gray-100 shadow-sm rounded-xl">
            ...
            <div class="p-6">
                ...
                <!-- Approver Form -->
                <form action="{{ route('admin.approver.update', $approver) }}" method="POST" class="space-y-6" id="approverForm">
                    @csrf
                    @method("PUT")
                    <!-- Name Field -->
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" id="name" name="name" value="{{ old('name', $approver->name) }}"
                                ...
                                placeholder="Enter approver full name" required>
                        ...
                        @enderror
                        <p class="mt-2 text-xs text-gray-500">Enter the approver's full name as it appears on official
                            documents</p>
                    </div>
