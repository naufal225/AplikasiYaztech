...
@section('subtitle', 'Update customer data')
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-2 text-sm text-gray-600">update customer record in the system</p>
            </div>
    ...
    <div class="max-w-2xl mx-auto">
        <div class="overflow-hidden bg-white border border-gray-100 shadow-sm rounded-xl">
            ...
            <div class="px-6 py-4 border-b border-gray-100 bg-gray-50">
                ...
                <p class="mt-1 text-sm text-gray-600">Please fill in the customer details below</p>
            </div>
            ...
            <div class="p-6">
                ...
                <!-- Customer Form -->
                <form action="{{ route('admin.customers.update', $customer) }}" method="POST" class="space-y-6" id="CustomerForm">
                    @csrf
                    @method('PUT')
                    <!-- Name Field -->
                    <div>
                        ...
                        @enderror
                        <p class="mt-2 text-xs text-gray-500">Enter the Customer's Name as it appears on official
                            documents</p>
                    </div>
                    ...
                    <div class="flex items-center justify-end pt-6 space-x-4 border-t border-gray-200">
                        ...
                        <button type="submit" id="submitBtn"
                            ...
                            <span id="submitBtnText">Update Customer</span>
