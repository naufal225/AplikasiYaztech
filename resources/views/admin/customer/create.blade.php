...
@section('subtitle', 'Add customer data')
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-2 text-sm text-gray-600">Create a new customer record in the system</p>
            </div>
    ...
    <div class="max-w-2xl mx-auto">
        <div class="overflow-hidden bg-white border border-gray-100 shadow-sm rounded-xl">
            ...
            <div class="p-6">
                ...
                <!-- Customer Form -->
                <form action="{{ route('admin.customers.store') }}" method="POST" class="space-y-6" id="CustomerForm">
                    @csrf
