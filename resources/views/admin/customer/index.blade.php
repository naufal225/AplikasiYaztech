...
@section('subtitle', 'Manage customer data')
...
<main class="relative z-10 flex-1 p-0 overflow-x-hidden overflow-y-auto bg-gray-50">
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Manage Customer</h1>
                <p class="mt-2 text-sm text-gray-600">Manage your customer data and information</p>
            </div>
            <div class="flex flex-col gap-3 mt-4 sm:mt-0 sm:flex-row">
                ...
                <a id="addCustomerBtn" href="{{ route('admin.customers.create') }}"
    ...
    <div class="mb-6">
        <div class="p-6 bg-white border border-gray-100 shadow-sm rounded-xl">
            <div class="">
                <form class="flex flex-col gap-4 sm:flex-row" action="{{ route("admin.customers.index") }}"
                    method="GET">
                    <div class="flex-1">
                        <div class="relative">
                        ...
                        <tr class="transition-colors duration-200 hover:bg-neutral-50">
                            ...
                            <td class="px-6 py-4 text-sm font-medium whitespace-nowrap">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <button type="button"
                                        class="delete-customer-btn text-error-600 hover:text-error-900"
    ...
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
            ...
            <div class="text-center">
                <h3 class="mb-2 text-lg font-semibold text-gray-900">Delete Customer</h3>
                <p class="mb-6 text-sm text-gray-500">
                    Are you sure you want to delete <span id="customerName" class="font-medium text-gray-900"></span>?
...
@push('scripts')
@vite("resources/js/admin/customer/script.js")
@endpush
