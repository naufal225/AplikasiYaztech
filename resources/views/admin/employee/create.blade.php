    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-2 text-sm text-gray-600">Create a new employee record in the system</p>
            </div>
    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="px-6 py-4 border-b border-gray-100 bg-gray-50">
                ...
                <p class="text-sm text-gray-600 mt-1">Please fill in the employee details below</p>
            </div>
            ...
            <div class="p-6">
                <!-- Success Message -->
                @if(session('success'))
                <div class="mb-6 flex items-center p-4 bg-green-50 border border-green-200 rounded-xl">
                ...
                <!-- Error Messages -->
                @if($errors->any())
                <div class="mb-6 flex items-start p-4 bg-red-50 border border-red-200 rounded-xl">
                    <div class="flex-shrink-0">
                ...
                <form action="{{ route('admin.employee.store') }}" method="POST" class="space-y-6" id="employeeForm">
                    ...
                    <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                        <!-- Cancel Button -->
                        <a href="{{ route('admin.employee.index') }}"
                            class="px-6 py-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                            Cancel
                        </a>

                        <!-- Submit Button -->
                        <button type="submit" id="submitBtn"
                            class="px-6 py-3 text-sm font-medium text-white bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 rounded-lg transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed">
                            <span id="submitBtnText">Add Employee</span>
                            <svg id="submitBtnSpinner" class="hidden animate-spin -mr-1 ml-2 h-4 w-4 text-white"
