                        ...
                        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center p-3 border rounded-lg bg-neutral-50 border-neutral-200">
                                    ...
                                    <span class="font-medium truncate text-neutral-900">{{ $officialTravel->employee->email }}</span>
                                </div>
                            </div>
                            <div class="space-y-2">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-start p-3 border rounded-lg bg-neutral-50 border-neutral-200">
                                    ...
                                    <span class="max-w-full overflow-y-auto break-all whitespace-pre-line text-neutral-900 max-h-40">{{ $officialTravel->note_1 ?? '-' }}</span>
                                </div>
                            </div>
                            <div class="space-y-2">
                                ...
                                <div class="flex items-start p-3 border rounded-lg bg-neutral-50 border-neutral-200">
                                    <i class="mr-3 fas fa-sticky-note text-info-600"></i>
                                    <span class="max-w-full overflow-y-auto break-all whitespace-pre-line text-neutral-900 max-h-40">{{ $officialTravel->note_2 ?? '-' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
